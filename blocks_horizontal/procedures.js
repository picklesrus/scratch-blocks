...
Blockly.Blocks['procedures_callnoreturn'] = {
  ...
  _updateDisplay: function() {
    ...
    for (var i = 0, component; component = procComponents[i]; i++) {
      ...
      if (newLabel == 'grow-and-shrink') {
        var image = new Blockly.FieldImage(Blockly.mainWorkspace.options.pathToMedia + "icons/grow.svg", 40, 40, 'alt');
        this.appendDummyInput().appendField(image);
      } else if (newLabel == 'pixelate') {
                var image = new Blockly.FieldImage(Blockly.mainWorkspace.options.pathToMedia + "icons/pixel.svg", 40, 40, 'alt');
        this.appendDummyInput().appendField(image);
      } else if (newLabel == 'swirl') {
                var image = new Blockly.FieldImage(Blockly.mainWorkspace.options.pathToMedia + "icons/whirl.svg", 40, 40, 'alt');
        this.appendDummyInput().appendField(image);
